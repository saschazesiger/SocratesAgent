...
// having in the list.
//
// About 807 KB uncompressed, 206 KB over the wire with the gzip the server
// already applies. xterm.js is 489 KB of that and the WebGL renderer 248 KB;
// both earn it, because a terminal that has to be fetched is a terminal that
// is not there in a tunnel.
const SHELL = [
  '/',
  '/static/css/app.css',
